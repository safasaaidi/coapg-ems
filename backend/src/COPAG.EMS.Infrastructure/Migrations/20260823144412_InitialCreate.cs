        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PreventivePlans_Equipments_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PreventiveTasks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PreventiveTasks_PreventivePlans_PreventivePlanId",
                        column: x => x.PreventivePlanId,
                        principalTable: "PreventivePlans",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PreventiveTasks_Users_AssignedTechnicianId",
                        column: x => x.AssignedTechnicianId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DiagnosticDetails = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PreventivePlans_EquipmentId",
                table: "PreventivePlans",
                column: "EquipmentId");

            migrationBuilder.CreateIndex(
                name: "IX_PreventiveTasks_AssignedTechnicianId",
                table: "PreventiveTasks",
                column: "AssignedTechnicianId");

            migrationBuilder.CreateIndex(
                name: "IX_PreventiveTasks_PreventivePlanId",
                table: "PreventiveTasks",
